...
| 5 | [API Provisioning](05-api-provisioning/) | Registering subgraphs, composing the schema, and rolling out router configuration | [**Partially implemented**](#status-notes)  |
